package repo.enrique.main;

import repo.enrique.database.JdbcVentasDatabaseService;
import repo.enrique.model.DefaultEstacionDeServicio;
import repo.enrique.ui.MainView;
...
public class Main {
    ...
    public static void main(String[] args) {
        inicializarDatabase();// crea las tablas que se usaran
        launchApplication();// lanza aplicacion
    }
